        ...
        <div class="container text-center contenedor">
            <div id="divFormulario" class="card">
                <div class="card-header">
                    Seleccione Dia - Mes -Ano, por favor
                </div>
                <div class="card-body">
                    <form id="formDatos">
                        <div class="row">
            ...
            <div id="divTarjeta" class="card tarjeta">
                <img id="imagenChica" src="https://www.antonio.com.mx/imagenes/nasa_logo.png" class="img-fluid" alt="Logo Nasa">
                <div class="card-body">
                    ...
                    <div class="btn-group d-flex" role="group">
                        <a id="botonVerHD" href="#" target="_blank" type="button" class="btn btn-primary w-100">Ver Imagen</a>
                    </div>
                </div>
            </div>
        </div>
